...
export function Footer() {
  ...
  return <footer className="border-t border-border-custom bg-[#05080D] pt-16 pb-8 text-white relative z-10">
    ...
    /* Resources & Support */
        ...
        <div className="pt-8 border-t border-border-custom flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-text-secondary/60 text-sm">
            © {(/* @__PURE__ */ new Date()).getFullYear()} KRAMIK. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            <span className="flex items-center gap-2 text-sm text-text-secondary/60">
              <span className="w-2 h-2 rounded-full bg-[#B5FF45] shadow-[0_0_8px_rgba(181,255,69,0.8)]" />
