...
export function DashboardPreview() {
  ...
  >
    ...
    key={i}
    className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-colors cursor-pointer ${item.active ? "bg-[#B5FF45]/10 text-[#B5FF45] font-medium" : "text-gray-400 hover:text-gray-200 hover:bg-white/5"}`}
  >
...
function StatCard({ icon: Icon, label, value }) {
  return <div className="group rounded-xl border border-white/5 bg-white/[0.02] p-4 transition-all duration-300 hover:bg-white/[0.05] hover:-translate-y-1 hover:shadow-lg hover:shadow-black/50 flex flex-col justify-between min-h-[100px]">
