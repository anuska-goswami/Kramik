...
import { 
  ArrowLeft, Users, Terminal, MessageSquare, FileText, 
  Target, Mic, Briefcase, ChevronRight, Sparkles, BookOpen, Clock, ChevronDown
} from 'lucide-react';
...
export function InterviewDetailPage({ onBack }: { onBack?: () => void }) {
  const { id } = useParams();
    ...
    >
      ...
      <div className="space-y-4">
        ...
        {questions.map((item: any, idx: number) => (
          <div key={idx} className="bg-[#0A0E17]/60 border border-white/5 rounded-2xl overflow-hidden hover:border-white/10 transition-colors">
            <div 
                  ...
                  <div className="p-6 bg-black/20 space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <ul className="space-y-2">
                          {item.mistakes.map((mistake: string, mIdx: number) => (
