...
export function SettingsContent({ onSignOut }) {
  ...
  const [profile, setProfile] = useState(() => {
    ...
    return saved ? JSON.parse(saved) : {
      ...
      github: "https://github.com/anuska-goswami",
      linkedin: "https://linkedin.com/in/anuskagoswami",
      dailyGoal: "2"
      // hours
    };
  });
  ...
  return <div className="p-4 lg:p-8 max-w-6xl mx-auto relative">
    ...
    className={`p-4 rounded-xl shadow-lg border text-sm font-medium flex items-center gap-2 pointer-events-auto backdrop-blur-md min-w-[280px]
                ${toast.type === "success" ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-800 dark:text-emerald-200" : toast.type === "error" ? "bg-rose-500/10 border-rose-500/20 text-rose-800 dark:text-rose-200" : "bg-blue-500/10 border-blue-500/20 text-blue-800 dark:text-blue-200"}
              `}
  >
  ...
  >
    ...
    className={`flex items-center gap-3 w-full px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200
              ${activeSection === "profile" ? "bg-accent-custom/10 text-accent-custom dark:bg-[#B5FF45]/10 dark:text-[#B5FF45]" : "text-text-secondary hover:text-text-primary hover:bg-item-hover"}
            `}
  >
    ...
    className={`flex items-center gap-3 w-full px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200
              ${activeSection === "notifications" ? "bg-accent-custom/10 text-accent-custom dark:bg-[#B5FF45]/10 dark:text-[#B5FF45]" : "text-text-secondary hover:text-text-primary hover:bg-item-hover"}
            `}
  >
    ...
    className={`flex items-center gap-3 w-full px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200
              ${activeSection === "security" ? "bg-accent-custom/10 text-accent-custom dark:bg-[#B5FF45]/10 dark:text-[#B5FF45]" : "text-text-secondary hover:text-text-primary hover:bg-item-hover"}
            `}
  >
    ...
    className={`flex items-center gap-3 w-full px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200
              ${activeSection === "database" ? "bg-accent-custom/10 text-accent-custom dark:bg-[#B5FF45]/10 dark:text-[#B5FF45]" : "text-text-secondary hover:text-text-primary hover:bg-item-hover"}
            `}
  >
    ...
    className={`flex items-center gap-3 w-full px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200
              ${activeSection === "help" ? "bg-accent-custom/10 text-accent-custom dark:bg-[#B5FF45]/10 dark:text-[#B5FF45]" : "text-text-secondary hover:text-text-primary hover:bg-item-hover"}
            `}
  >
    ...
    /* PROFILE SECTION */
            ...
            {activeSection === "profile" && <motion.div
    key="profile"
  ...
  >
    ...
    /* NOTIFICATIONS SECTION */
            ...
            {activeSection === "notifications" && <motion.div
    key="notifications"
    initial={{ opacity: 0, y: 10 }}
    animate={{ opacity: 1, y: 0 }}
    exit={{ opacity: 0, y: -10 }}
  ...
  >
    ...
    /* SECURITY SECTION */
            ...
            {activeSection === "security" && <motion.div
    key="security"
    initial={{ opacity: 0, y: 10 }}
    animate={{ opacity: 1, y: 0 }}
    exit={{ opacity: 0, y: -10 }}
  ...
  >
    ...
    /* DATA & BACKUP */
            ...
            {activeSection === "database" && <motion.div
    key="database"
    initial={{ opacity: 0, y: 10 }}
    animate={{ opacity: 1, y: 0 }}
    exit={{ opacity: 0, y: -10 }}
