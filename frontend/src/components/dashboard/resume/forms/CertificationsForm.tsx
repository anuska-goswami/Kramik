...
export function CertificationsForm({ data, onChange }: { data: ResumeData['certifications']; onChange: (data: ResumeData['certifications']) => void }) {
  const handleAdd = () => {
    onChange([...data, {
            ...
            <div className="pl-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input 
                    type="text" value={cert.name} onChange={(e) => handleUpdate(index, 'name', e.target.value)}
                ...
                <div>
                  ...
                  <input 
                    type="text" value={cert.organization} onChange={(e) => handleUpdate(index, 'organization', e.target.value)}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
                <div>
                  ...
                  <input 
                    type="text" value={cert.date} onChange={(e) => handleUpdate(index, 'date', e.target.value)}
                ...
                <div>
                  ...
                  <input 
                    type="text" value={cert.credentialId} onChange={(e) => handleUpdate(index, 'credentialId', e.target.value)}
                ...
                <div>
                  ...
                  <input 
                    type="url" value={cert.url} onChange={(e) => handleUpdate(index, 'url', e.target.value)}
                    placeholder="https://..."
                    className="w-full bg-[#05080D] border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-[#B5FF45]/50 transition-colors"
                  />
                </div>
