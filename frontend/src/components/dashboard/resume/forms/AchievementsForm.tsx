...
export function AchievementsForm({ data, onChange }: { data: ResumeData['achievements']; onChange: (data: ResumeData['achievements']) => void }) {
  const handleAdd = () => {
    onChange([...data, {
          ...
          >
            ...
            <div className="pl-4">
              <div>
                ...
                <input 
                  type="text" value={item.title} onChange={(e) => handleUpdate(index, 'title', e.target.value)}
              ...
              <div className="mt-4">
                ...
                <textarea 
                  value={item.description} onChange={(e) => handleUpdate(index, 'description', e.target.value)}
