...
export function ExperienceForm({ data, onChange }: { data: ResumeData['experience']; onChange: (data: ResumeData['experience']) => void }) {
  const handleAdd = () => {
    onChange([...data, {
            ...
            <div className="pl-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input 
                    type="text" value={exp.company} onChange={(e) => handleUpdate(index, 'company', e.target.value)}
                ...
                <div>
                  ...
                  <input 
                    type="text" value={exp.role} onChange={(e) => handleUpdate(index, 'role', e.target.value)}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
                <div>
                  ...
                  <select 
                    value={exp.type} onChange={(e) => handleUpdate(index, 'type', e.target.value)}
                ...
                <div>
                  ...
                  <input 
                    type="text" value={exp.startDate} onChange={(e) => handleUpdate(index, 'startDate', e.target.value)}
                ...
                <div>
                  ...
                  <input 
                    type="text" value={exp.endDate} onChange={(e) => handleUpdate(index, 'endDate', e.target.value)}
              ...
              <div className="mt-4">
                ...
                <textarea 
                  value={exp.responsibilities} onChange={(e) => handleUpdate(index, 'responsibilities', e.target.value)}
