...
export function ResumePreview({ data }: { data: ResumeData }) {
  ...
  return (
    <div className="w-full h-full p-8 md:p-12 font-sans bg-white text-gray-900 leading-relaxed custom-scrollbar overflow-y-auto">
      {/* Header */}
      <div className="text-center mb-6">
        ...
        {personal.headline && (
          <h2 className="text-sm font-medium text-gray-600 mb-3">{personal.headline}</h2>
        )}
      ...
      {/* Skills */}
      {(skills.technical.length > 0 || skills.core.length > 0 || skills.tools.length > 0 || skills.soft.length > 0 || skills.languages.length > 0) && (
        <div className="mb-5">
            ...
            {experience.map(exp => (
              <div key={exp.id}>
                ...
                {exp.responsibilities && (
                  <div className="text-[11px] text-gray-800 mt-1 whitespace-pre-wrap pl-3" style={{ textIndent: '-0.75rem' }}>
        ...
        <div className="mb-5">
          ...
          <div className="space-y-1.5 text-[11px]">
            {achievements.map(ach => (
              <div key={ach.id} className="pl-3" style={{ textIndent: '-0.75rem' }}>
