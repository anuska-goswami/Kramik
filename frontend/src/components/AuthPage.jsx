...
export function AuthPage({ onBack, onSuccess }) {
  ...
  return <div className="min-h-screen bg-[var(--color-navy)] text-white flex items-center justify-center relative overflow-hidden py-12 px-6">
  ...
  >
            {mode === "signup" && <div className="relative group">
                <input
    type="text"
    id="fullname"
    placeholder=" "
  ...
  >
    ...
    /* Password Strength Indicator */
                ...
                <div className="flex gap-1.5 mt-1 px-1">
                  <div className="h-1 flex-1 rounded-full bg-[#B5FF45]" />
                  <div className="h-1 flex-1 rounded-full bg-[#B5FF45]" />
            ...
            {mode === "signin" && <div className="flex items-center justify-between mt-1 px-1">
            ...
            {mode === "signup" && <label className="flex items-start gap-3 mt-1 px-1 cursor-pointer group">
