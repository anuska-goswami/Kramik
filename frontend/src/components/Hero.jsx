...
function AnimatedCounter({ value, suffix = "", duration = 1.5 }) {
  ...
  return <span ref={ref} className="font-heading font-black text-3xl sm:text-4xl lg:text-5xl text-white tracking-tight">
      {count.toLocaleString()}{suffix}
    </span>;
}
function FAQItem({ question, answer }) {
  const [isOpen, setIsOpen] = useState(false);
  return <div className="border border-white/5 rounded-2xl bg-white/[0.01] hover:bg-white/[0.02] transition-colors duration-300 overflow-hidden">
      <button
...
export function Hero() {
  ...
  return <div className="bg-[#05080D] text-white overflow-hidden font-sans">
  ...
  >
                <div className="flex -space-x-3">
                  {[1, 2, 3].map((i) => <div key={i} className="w-10 h-10 rounded-full border-[2.5px] border-[#05080D] overflow-hidden bg-white/5">
  ...
  >
    ...
    /* Stat 1 */
            ...
            <div className="p-5 sm:p-6 rounded-2xl bg-white/[0.01] border border-white/5 backdrop-blur-md flex flex-col items-center text-center justify-between group hover:border-[#B5FF45]/20 transition-all duration-300">
              ...
              <div className="flex flex-col">
                <AnimatedCounter value={1e4} suffix="+" />
    ...
    /* Stat 2 */
            ...
            <div className="p-5 sm:p-6 rounded-2xl bg-white/[0.01] border border-white/5 backdrop-blur-md flex flex-col items-center text-center justify-between group hover:border-[#B5FF45]/20 transition-all duration-300">
              ...
              <div className="flex flex-col">
                <AnimatedCounter value={5e3} suffix="+" />
    ...
    /* Features Grid */
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {features.map((feat, idx) => <motion.div
    key={idx}
  ...
  >
    ...
    /* Connecting Horizontal Line (visible on desktop md) */
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:gap-10">
              {processSteps.map((step, idx) => <div key={idx} className="flex flex-col items-center text-center group relative px-2">
    ...
    /* Callouts rendered as absolutely positioned glass pills on Desktop */
              ...
              {callouts.map((call, idx) => <motion.div
    key={idx}
  ...
  >
    ...
    /* Mobile Callout Grid */
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {callouts.map((call, idx) => <div key={idx} className="p-4 rounded-xl border border-white/5 bg-white/[0.01] text-left">
  ...
  >
    ...
    /* Stars Row */
                ...
                <div className="flex items-center gap-1">
                  {[...Array(test.rating)].map((_, i) => <Star key={i} className="w-4 h-4 text-[#B5FF45]" fill="currentColor" />)}
                </div>
