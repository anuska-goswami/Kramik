...
function AppRoutes() {
  ...
  />
          ...
          <Route path="/subjects/:id" element={<ProtectedRoute>
              <DashboardLayout
    onSignOut={handleSignOut}
    onNavigateToProfile={() => navigate("/profile")}
  ...
  />
          ...
          <Route path="/mock-tests" element={<ProtectedRoute>
              <DashboardLayout
    onSignOut={handleSignOut}
    onNavigateToProfile={() => navigate("/profile")}
  ...
  />
          ...
          <Route path="/mock-test-result" element={<ProtectedRoute>
              <DashboardLayout
    onSignOut={handleSignOut}
    onNavigateToProfile={() => navigate("/profile")}
  ...
  />
          ...
          <Route path="/aptitude" element={<ProtectedRoute>
              <DashboardLayout
    onSignOut={handleSignOut}
    onNavigateToProfile={() => navigate("/profile")}
    initialTab="aptitude"
  ...
  />
          ...
          <Route path="/company-prep" element={<ProtectedRoute>
              <DashboardLayout
    onSignOut={handleSignOut}
    onNavigateToProfile={() => navigate("/profile")}
  ...
  />
          ...
          <Route path="/company-prep/:id" element={<ProtectedRoute>
              <DashboardLayout
    onSignOut={handleSignOut}
    onNavigateToProfile={() => navigate("/profile")}
  ...
  />
          ...
          <Route path="/interview-prep/:id" element={<ProtectedRoute>
              <DashboardLayout
    onSignOut={handleSignOut}
    onNavigateToProfile={() => navigate("/profile")}
