...
import { 
  FileEdit, Clock, HelpCircle, Award, CheckCircle, PlayCircle, 
  ArrowRight, ShieldAlert, ChevronRight, Lock, Sparkles, Send, Loader2
} from 'lucide-react';
...
export function MockTestsContent({ onShowResult }: MockTestsContentProps) {
  const [activeScreen, setActiveScreen] = useState<'list' | 'taking' | 'submitting'>('list');
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between gap-4 pt-2">
                      {isCompleted ? (
                        ...
                        <div className="text-xs text-gray-500">Not attempted yet</div>
                      )}
                    ...
                    return (
                      <button
                        ...
                        className={`w-full text-left p-4 rounded-2xl border transition-all ${
                          isSelected 
                            ? 'bg-[#B5FF45]/10 border-[#B5FF45] text-white font-semibold' 
                            : 'bg-white/[0.01] border-white/5 hover:bg-white/[0.02] text-gray-300'
                        }`}
                      >
                        {opt}
                      </button>
